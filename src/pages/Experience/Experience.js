  ...
  return (
    <Page id="Experience" header="Experience">
      ...
      >
        ...
        <div className='quote'>
          <i>"[Ryan] is quick in learning new technologies and skills and does not shy away from challenges…. He also communicates well and [is] very pleasant to work with…. He is a great team player, always ready for new tasks and [to] help out on the project as much as he could. He is able to utilize the resources offered by EY and the immediate team to ramp up his skills quickly. Overall with his positive attitude, cooperative spirit, and quick learning aptitude, Ryan will be a great addition any team."</i>
        </div>
      </Card>
      <Card 
        image={Lehigh_logo}
